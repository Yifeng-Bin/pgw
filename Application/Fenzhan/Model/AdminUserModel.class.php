...
class AdminUserModel extends CommonModel
{
    ...
    public function editFenzhanUser()
    {
        ...
        if ($result === false) {
            ...
            M('AdminAuthGroupAccess')->where(array(
                'uid' => $uid
            ))->delete();
    ...
    public function login()
    {
        ...
        $rs = $this->field('uid,user_name,password,region_id,contact,phone,email,status,error_times,last_login_time')
            ->where(array(
    ...
    {
        return $this->field('uid,is_admin,user_name,region_id,contact,phone,email,status,last_login_time')->find($uid);
    }
}