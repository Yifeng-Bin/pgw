...
class AfterSaleController extends CommonController {
    ...
    public function index() {
        ...
        $afterSaleList = M('TenderAfterSale')->alias('s')->field('s.id,s.tender_id,s.user_id,s.type,s.content,s.refund_money,s.is_confirm,s.status,s.add_time,s.need_service,t.tender_name')
                ->join('left join __TENDER__ as t on t.tender_id = s.tender_id')
    ...
    public function detail(){
        ...
        $afterSaleInfo = M('TenderAfterSale')->alias('s')
                ->field('s.id,s.tender_id,s.user_id,s.type,s.content,s.refund_money,s.is_confirm,s.status,s.attachment_01,s.attachment_02,s.attachment_03,s.add_time,s.need_service,s.refund_status,s.refund_remark,t.tender_name,t.pay_total')
