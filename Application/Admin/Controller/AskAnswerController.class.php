...
class AskAnswerController extends CommonController {
    ...
    public function del() {
        ...
        M('ArticleComment')->data(array('is_delete' => 1))->where(array('comment_id' => $comment_id))->save();  
