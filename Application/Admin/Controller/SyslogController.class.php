...
class SyslogController extends CommonController {
    ...
    public function index() {
        ...
        $this->logList = M('AdminLog')->alias('l')->join('left join __ADMIN_USER__ as u on l.user_id = u.uid')->field('u.user_name,l.log_id,l.log_format_time,l.user_id,l.log_info,l.ip_address')
